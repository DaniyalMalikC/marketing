...
export function BackgroundIllustration() {
  return (
    <div className="pointer-events-none absolute inset-0 -z-1">
      ...
      <div className="absolute -left-24 bottom-10 h-72 w-72 rounded-full bg-[color-mix(in_oklab,var(--color-primary)_20%,transparent)] blur-[130px]" />
      <div className="absolute right-0 top-24 h-72 w-72 rounded-full bg-[color-mix(in_oklab,var(--color-primary)_12%,transparent)] blur-[130px]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_70%,color-mix(in_oklab,var(--color-primary)_4%,transparent),transparent_45%)]" />
      ...
      <div className="pointer-events-none absolute inset-x-0 -bottom-8 h-32 bg-gradient-to-r from-[color-mix(in_oklab,var(--color-primary)_22%,transparent)] via-transparent to-transparent blur-3xl" />
